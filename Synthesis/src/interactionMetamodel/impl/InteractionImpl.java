 ...
 * </p>
 * <ul>
 *   <li>{@link interactionMetamodel.impl.InteractionImpl#getMessages <em>Messages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionImpl extends MinimalEObjectImpl.Container implements Interaction {
	...
	protected EClass eStaticClass() {
		return InteractionMetamodelPackage.Literals.INTERACTION;
	}
	...
	public EList<Message> getMessages() {
		if (messages == null) {
			messages = new EObjectResolvingEList<Message>(Message.class, this, InteractionMetamodelPackage.INTERACTION__MESSAGES);
		}
		return messages;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InteractionMetamodelPackage.INTERACTION__MESSAGES:
				return getMessages();
		}
