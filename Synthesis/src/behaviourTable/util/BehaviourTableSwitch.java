 ...
 * @generated
 */
public class BehaviourTableSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BehaviourTablePackage.BEHAVIOUR: {
				Behaviour behaviour = (Behaviour)theEObject;
				T result = caseBehaviour(behaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourTablePackage.BEHAVIOUR_TABLE: {
				BehaviourTable behaviourTable = (BehaviourTable)theEObject;
				T result = caseBehaviourTable(behaviourTable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourTablePackage.OUT_MESSAGE: {
				OutMessage outMessage = (OutMessage)theEObject;
				T result = caseOutMessage(outMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourTablePackage.ACTIVATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Behaviour Table</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Behaviour Table</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBehaviourTable(BehaviourTable object) {
		return null;
	}
